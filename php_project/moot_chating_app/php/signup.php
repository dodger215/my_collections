                    ...
                    if(in_array($img_ext, $extensions) === true){
                        ...
                        if(in_array($img_type, $types) === true){
                            ...
                            if(move_uploaded_file($tmp_name,"images/".$new_img_name)){
                                ...
                                $insert_query = mysqli_query($conn, "INSERT INTO users (unique_id, fname, lname, username, password, img, status)
                                VALUES ({$ran_id}, '{$fname}','{$lname}', '{$username}', '{$encrypt_pass}', '{$new_img_name}', '{$status}')");
                                if($insert_query){
