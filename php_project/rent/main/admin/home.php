...
<div class="wrapper">
    <section class="orders_page mb-4" style="max-width: 100%; height: auto;">
        <div class="d-flex justify-content-between align-items-center main">
            ...
            <h5 class="mb-0">Rent a house</h5>
            <button type="button" class="btn btn-success btn-sm create">
            <i class="fas fa-plus"></i> Create your content
            </button>
        </div>
...
<script>
                        ...
                        <div class="card mb-3" style="width: 100%; height: auto;">
                            <div class="card-body">
                                ...
                                <div class="view d-flex justify-content-between">
                                    ...
                                    <span class="name">location: ${product.location}</span>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    ...
                                    <form method="POST">
                                        <button type="button" class="btn btn-primary btn-sm" onclick="openPopup('${product.description}', '${product.product_id}', '${product.location}')">
                                            <i class="fas fa-box"></i> Rent Now
                                        </button>
                                    </form>
                                </div>
                            </div>
    ...
    function openPopup(description, productId, location) {
    ...
    // Format location for OpenStreetMap search
    const mapUrl = `https://www.openstreetmap.org/search?query=${encodeURIComponent(location)}`;
